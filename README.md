...
7. Runs are scheduled **every two hours at :30 Singapore time, 24/7**, starting
   21:30 SGT (`30 1-23/2 * * *`, `timezone: Asia/Singapore`; odd hours in UTC).
   ...
   This replaces the US-open-based
